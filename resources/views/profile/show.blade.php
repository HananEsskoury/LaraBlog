...
.profile-banner {
    height: 140px;
    background: linear-gradient(135deg, #2a2018 0%, var(--terracotta) 100%);
}
.profile-body { padding: 0 40px 40px; }
.profile-top {
    display: flex;
...
.btn-edit:hover { background: var(--terra-dark); }
        ...
        <div class="notif-wrap" style="position:relative;">
            ...
            <div class="profile-dropdown" id="profileDropdown">
                @if(Auth::user()->usertype === 'auteur')
                        <a href="{{ route('auteur.profile', Auth::user()->id) }}" class="profile-drop-link active">👤 Mon profil</a>
                    @else
                        <a href="{{ route('profile.show') }}" class="profile-drop-link active">👤 Mon profil</a>
                    @endif
...
<div class="drawer" id="drawer">
    ...
    <div class="drawer-body">
        ...
        @if(Auth::user()->usertype === 'auteur')
        <a href="{{ route('auteur.profile', Auth::user()->id) }}" class="drawer-item active">
...
<div class="admin-shell">
    ...
    <div style="background:#fdf0f0; color:#b83a3a; padding:12px 18px; margin-bottom:20px; border-radius:10px; border:1px solid rgba(184,58,58,.25); font-size:13px;">
        <i class="fas fa-exclamation-circle"></i> {{ $errors->userDeletion->first() }}
    </div>
@endif
    ...
    @if($user->avatar)
        <img src="{{ asset('img/' . $user->avatar) }}" class="profile-avatar" alt="Avatar">
    @else
        <div class="profile-avatar-initials">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
    @endif

    <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-top: 56px;">
        <a href="{{ route('profile.edit') }}" class="btn-edit">
            <i class="fas fa-pen"></i> Modifier
        </a>

        <button type="button" class="btn-edit" onclick="openDeleteModal()">
            <i class="fas fa-trash"></i> Supprimer
                    ...
                    @else
                        <div class="profile-bio-empty">Aucune bio renseignée.</div>
                    @endif
