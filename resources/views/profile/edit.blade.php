...
.file-label:hover { background: var(--warm-deep); border-color: var(--terracotta); }
...
.btn-cancel:hover { background: var(--warm-deep); border-color: var(--terracotta); color: var(--terracotta); }
.saved-message {
    font-size: 13px;
    color: var(--green);
    display: flex;
...
@media (max-width: 768px) {
    ...
    .edit-card-header, .edit-card-body { padding: 20px; }
        ...
        <div class="notif-wrap" style="position:relative;">
            ...
            <div class="profile-dropdown" id="profileDropdown">
                 @if(Auth::user()->usertype === 'auteur')
                        <a href="{{ route('auteur.profile', Auth::user()->id) }}" class="profile-drop-link">👤 Mon profil</a>
                    @else
                        <a href="{{ route('profile.show') }}" class="profile-drop-link">👤 Mon profil</a>
                    @endif
                <a href="{{ route('profile.edit') }}" class="profile-drop-link active">⚙️ Paramètres</a>
...
<div class="drawer" id="drawer">
    ...
    <div class="drawer-body">
        ...
        <span class="drawer-label">Mon compte</span>
         @if(Auth::user()->usertype === 'auteur')
        <a href="{{ route('auteur.profile', Auth::user()->id) }}" class="drawer-item">
        ...
        @endif
        <a href="{{ route('profile.edit') }}" class="drawer-item active">
...
<div class="admin-shell">
    <main class="main">
        ...
        <div class="edit-container">
            @if(Auth::user()->usertype === 'auteur')            
            <a href="{{ route('auteur.profile', Auth::user()->id) }}" class="back-link">
            ...
            <div class="edit-card">
                <div class="edit-card-header">
                    <h2>Modifier mon <em>profil</em></h2>
                    <p>Mettez à jour vos informations personnelles et votre photo.</p>
                </div>

                <div class="edit-card-body">
                    @if(session('status') === 'profile-updated')
                        <div class="saved-message" style="margin-bottom: 20px;">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="avatar-section">
                            ...
                            <div class="avatar-upload">
                                ...
                                <p class="file-hint">PNG, JPG, WEBP — 20MB max</p>
                        ...
                        <div class="form-group">
                            ...
                            <p class="file-hint">Max 10000 caractères</p>
