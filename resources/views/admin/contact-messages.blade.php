...
.btn-view:hover { background: var(--terracotta); color: #fff; border-color: var(--terracotta); }
.btn-delete {
    background: var(--red-bg);
    color: var(--red);
    border-color: rgba(184,58,58,.2);
}
...
.status-read { background: var(--green-bg); color: var(--green); }
.status-unread { background: var(--yellow-bg); color: var(--yellow); }
...
.pagination a:hover { background: var(--terracotta); color: #fff; border-color: var(--terracotta); }
...
<div class="drawer" id="drawer">
    ...
    <div class="drawer-body">
        ...
        <a href="{{ route('admin.contact.messages') }}" class="drawer-item active">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            Messages
            @if(isset($unreadCount) && $unreadCount > 0)
                <span class="n-badge" style="background:var(--terracotta);color:#fff;margin-left:auto;">{{ $unreadCount }}</span>
            @endif
        </a>
...
<div class="admin-shell">
    <main class="main">
        ...
        <div class="page-header">
            ...
            <p>Gérez les messages envoyés depuis le formulaire de contact.</p>
        </div>
            ...
            <div class="message-item {{ !$message->is_read ? 'unread' : '' }}">
                <div class="message-content">
                    <div class="message-header">
                        ...
                        <span class="message-subject">{{ $message->subject_label }}</span>
                    ...
                    <div class="message-preview">{{ Str::limit($message->message, 150) }}</div>
                </div>
                <div class="message-actions">
                    <a href="{{ route('admin.contact.message.show', $message->id) }}" class="btn-icon btn-view">
                    ...
                    <form method="POST" action="{{ route('admin.contact.message.delete', $message->id) }}" style="display: inline;" id="form-delete-{{ $message->id }}">
                        @csrf @method('DELETE')
                        <button type="button" class="btn-icon btn-delete" onclick="openConfirmDelete({{ $message->id }}, '{{ addslashes($message->name) }}')">
                            <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
